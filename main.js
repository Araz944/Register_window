...
function buttonClick() {
    ...
    if(regUsernameLength.test(username) == false && 
        ...
        message.innerHTML = "*Please insert valid inputs";
        setTimeout(function buttonClick() {
            message.style.display = "none";
        }, 3000);
        return;
    ...
    if(regUsername.test(username) != true) {
        ...
        message.backgroundColor = "red";
        message.style.textAlign = "center";
        message.innerHTML = "*Username must not contain special character (except \"-\" and \"_\")";
        setTimeout(function buttonClick() {
            message.style.display = "none";
    ...
    if(regUsernameLength.test(username) != true) {
        ...
        message.backgroundColor = "red";
        message.style.textAlign = "center";
        message.innerHTML = "*Username must contain between 3 and 20 characters";
        setTimeout(function buttonClick() {
            message.style.display = "none";
            form.style.height = "300px";
        }, 3000);
    ...
    if(regEmail.test(email) != true) {
        ...
        message.backgroundColor = "red";
        message.style.textAlign = "center";
        message.innerHTML = "*Please insert valid email address";
        setTimeout(function buttonClick() {
            message.style.display = "none";
        }, 3000);
        return;
    ...
    if(regPassword.test(password) != true) {
        ...
        message.backgroundColor = "red";
        message.style.textAlign = "center";
        message.innerHTML = "*Password must contain alphanumeric characters between 6 and 15";
        setTimeout(function buttonClick() {
            message.style.display = "none";
            form.style.height = "300px";
        }, 3000);
    ...
    if(password != again) {
        ...
        message.style.textAlign = "center";
        message.innerHTML = "*Be sure your password fields match";
        setTimeout(function buttonClick() {
            message.style.display = "none";
        }, 3000);
        return;
